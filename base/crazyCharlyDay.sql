...
--
-- Hôte : localhost
-- Généré le : jeu. 16 fév. 2023 à 22:39
...
INSERT INTO `panier` (`login`, `idProduit`, `qte`) VALUES
('admin', 1, 6);
...
(14, 5, 'Ronde des saisons \"Nature\"', '2.90', 100, 'Au lait de vaches nourries sans OGM.', 'Ingrédients : lait crue, ferments lactiques, présure, sel<p>Producteur :L\'étoile de la colline', 'Goviller', 32, 48.497536, 6.009661, 'img/14.jpg'),
...
('admin', '$2y$12$x5QQA79pPkT6qqYhHImUjeSh.FV6Ab5NZ1BdTHHXzBaaZYnjKG.3K', 'admin@gmail.com', NULL, NULL, NULL, 'q92c6056f8f43v91vr6ts4bxmr8124q7c9753tiu14l2l57p2r', 1),
('user1', '$2y$12$257vdL5hSnh94fby2/NdceIhQpDPPTjejjoKelxBBraIVGUY18/dG', 'user1@gmail.com', NULL, NULL, NULL, '66y2qrhu849m36s53s05epjw445vduwdxct590v5f65e5v75bw', 0);
